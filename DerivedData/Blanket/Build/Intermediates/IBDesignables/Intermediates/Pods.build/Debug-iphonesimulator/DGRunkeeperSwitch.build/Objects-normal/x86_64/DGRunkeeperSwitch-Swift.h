...
SWIFT_CLASS("_TtC17DGRunkeeperSwitch17DGRunkeeperSwitch")
...
@interface DGRunkeeperSwitch (SWIFT_EXTENSION(DGRunkeeperSwitch)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)gestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC17DGRunkeeperSwitch29DGRunkeeperSwitchRoundedLayer")
