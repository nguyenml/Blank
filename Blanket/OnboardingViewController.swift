...
class OnboardingViewController: UIViewController, PaperOnboardingDataSource {
    ...
    func onboardingItemAtIndex(_ index: Int) -> OnboardingItemInfo {
        ...
        return [
            (imageName: "brush", title: "Easy to Write", description: "Every day, when you open the app, you are given till the end of the day to complete an entry. An easy and initiative access button reduces roadblocks between you and your writing.", iconName: "", color: backgroundColor1, titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont: titleFont, descriptionFont: descriptionFont),
