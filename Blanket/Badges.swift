...
class BadgeClass{
    ...
    init(){
        ...
        badgeFor3Days = IndividualBadge.init(name: "3 in a Row",message: "Three days in a row! Looks like you're really on to something. There may have meen doubts but now you're more confident that you can do this.", earned:false, number:3,image:UIImage(named: "darker_day_circle.png")!)
        badges.append(badgeFor3Days)
        badgeFor10Days = IndividualBadge.init(name: "Streak",message: "10 days in a row! You can start to see your progress now. Writing is another muscle, it's been a bit sore the past couple days but now it's stronger than ever.", earned:false, number:10, image:UIImage(named: "darkest_day_progression.png")!)
        badges.append(badgeFor10Days)
        badgeFor20Days = IndividualBadge.init(name: "Hot Streak",message: "21 Days! Congratulations you did it. 21 days is how long it takes to create a habit. Writing everyday has become a part of your life.", earned:false, number:21,image:UIImage(named: "sandy_blue_progression.png")!)
