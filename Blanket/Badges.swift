...
class BadgeClass{
    ...
    init(){
        var image = #imageLiteral(resourceName: "green_blue_progresion")
        badgeForADay = IndividualBadge.init(name: "A Fresh Start",message: "You wrote your first day! Writing is a long and fulfilling journey and you just took your first steps. ", earned:false, number:1, image:UIImage(named: "day_circle.png")!)
        badges.append(badgeForADay)
        badgeFor3Days = IndividualBadge.init(name: "3 in a Row",message: "Three days in a row. This isn't a fluke anymore. You may have had your doubts but now you're confident that you can do this.", earned:false, number:3,image:UIImage(named: "darker_day_circle.png")!)
        badges.append(badgeFor3Days)
        badgeFor10Days = IndividualBadge.init(name: "Streak",message: "10 days in a row! You can start to see your progress now. Writing is another muscle, it's been sore the past couple days but now it's stronger than ever.", earned:false, number:10, image:UIImage(named: "darkest_day_progression.png")!)
        badges.append(badgeFor10Days)
        badgeFor20Days = IndividualBadge.init(name: "Hot Streak",message: "21 Days! Congratulations you did it. This is how long it takes to develop a good habit. You can add writing to the same categories as drinking water and sleeping.", earned:false, number:21,image:UIImage(named: "sandy_blue_progression.png")!)
        badges.append(badgeFor20Days)
        badgeFor50Days = IndividualBadge.init(name: "The Half",message: "50 Days! That's almost two months! Looks like you're about to stop counting by day and start counting the month.", earned:false, number:50,image:UIImage(named: "light_green_blue_progression.png")!)
        badges.append(badgeFor50Days)
        badgeFor100Days = IndividualBadge.init(name: "The Big 100",message: "Triple digits. Not many people will reach this goal post. But here you are. It was no doubt a difficult journey, but you're not done yet. You've set your eyes on even bigger goals.", earned:false, number:100,image:UIImage(named: "light_green_red_progression.png")!)
        badges.append(badgeFor100Days)
        badgeFor500Words = IndividualBadge.init(name: "The Calf",message: "Milo of Croton was said to have carried a calf with him since he as a boy. As the calf grew, so did the strength of Milo. 500 words seems like a calf, but with patience it will become a bull.", earned:false, number: 500,image:UIImage(named: "light_blue_progression.png")!)
        badges.append(badgeFor500Words)
        badgeFor2000Words = IndividualBadge.init(name: "The Turtle and the Hare",message: "The first 2000 words can come in the first couple days or the first couple weeks. The only important part is that it comes. Looks like it came to you.", earned:false, number: 2000,image:UIImage(named: "green_red_progression.png")!)
        badges.append(badgeFor2000Words)
        badgeFor5000Words = IndividualBadge.init(name: "The Mouse",message: "5000 words can sneak up on you. At this point you're not counting anymore, the words just pour out of you with ease. The weight of writing everyday doesn't seem so heavy anymore.", earned:false, number: 5000,image:UIImage(named: "dark_green_blue_progression.png")!)
